...
// - 可聚焦的只剩**第一组 10 个** logo。此前两轨里第一轨的 40 个 Link 全部
//   可 Tab，键盘用户要按 40 次才能走过 hero，屏幕阅读器逐条朗读 4 遍
// - REPEAT_COUNT 4 → 3：无缝双轨的覆盖要求作用于**单轨**，单组 ≈1463px，
//   3 组 ≈4389px 已覆盖 4K(3840)；降到 2 会在 ≥2927px 视口露空档。
//   节点 80 → 60，合成层宽度 11708px → ≈8778px
