        ...
        return (
          <AnimateOnScroll key={index} delay={index * 60}>
            <div className="card-surface rounded-xl overflow-hidden">
              ...
              >
                <span className="text-sm font-medium text-txt-primary">{faq.question}</span>
                <span className={`flex-shrink-0 w-5 h-5 flex items-center justify-center text-txt-quaternary transition-transform duration-300 ease-out-expo ${isOpen ? 'rotate-45' : ''}`}>
